...
namespace Jni
{
    void InitCallbacks(JNIEnv* env) {
        jclass jImListClipperCallback = env->FindClass("imgui/lordbanana/callback/ImListClipperCallback");
        jImListClipperCallbackAcceptMID = env->GetMethodID(jImListClipperCallback, "accept", "(I)V");

        jclass jImStrConsumer = env->FindClass("imgui/lordbanana/callback/ImStrConsumer");
        jImStrConsumerAcceptMID = env->GetMethodID(jImStrConsumer, "accept", "(Ljava/lang/String;)V");

        jclass jImStrSupplier = env->FindClass("imgui/lordbanana/callback/ImStrSupplier");
        jImStrSupplierGetMID = env->GetMethodID(jImStrSupplier, "get", "()Ljava/lang/String;");

        jclass jImPlatformFuncViewport = env->FindClass("imgui/lordbanana/callback/ImPlatformFuncViewport");
        jImPlatformFuncViewportAcceptMID = env->GetMethodID(jImPlatformFuncViewport, "accept", "(Limgui/lordbanana/ImGuiViewport;)V");

        jclass jImPlatformFuncViewportFloat = env->FindClass("imgui/lordbanana/callback/ImPlatformFuncViewportFloat");
        jImPlatformFuncViewportFloatAcceptMID = env->GetMethodID(jImPlatformFuncViewportFloat, "accept", "(Limgui/lordbanana/ImGuiViewport;F)V");

        jclass jImPlatformFuncViewportImVec2 = env->FindClass("imgui/lordbanana/callback/ImPlatformFuncViewportImVec2");
        jImPlatformFuncViewportImVec2AcceptMID = env->GetMethodID(jImPlatformFuncViewportImVec2, "accept", "(Limgui/lordbanana/ImGuiViewport;Limgui/lordbanana/ImVec2;)V");

        jclass jImPlatformFuncViewportString = env->FindClass("imgui/lordbanana/callback/ImPlatformFuncViewportString");
        jImPlatformFuncViewportStringAcceptMID = env->GetMethodID(jImPlatformFuncViewportString, "accept", "(Limgui/lordbanana/ImGuiViewport;Ljava/lang/String;)V");

        jclass jImPlatformFuncViewportSuppImVec2 = env->FindClass("imgui/lordbanana/callback/ImPlatformFuncViewportSuppImVec2");
        jImPlatformFuncViewportSuppImVec2GetMID = env->GetMethodID(jImPlatformFuncViewportSuppImVec2, "get", "(Limgui/lordbanana/ImGuiViewport;Limgui/lordbanana/ImVec2;)V");

        jclass jImPlatformFuncViewportSuppBoolean = env->FindClass("imgui/lordbanana/callback/ImPlatformFuncViewportSuppBoolean");
        jImPlatformFuncViewportSuppBooleanGetMID = env->GetMethodID(jImPlatformFuncViewportSuppBoolean, "get", "(Limgui/lordbanana/ImGuiViewport;)Z");

        jclass jImPlatformFuncViewportSuppFloat = env->FindClass("imgui/lordbanana/callback/ImPlatformFuncViewportSuppFloat");
        jImPlatformFuncViewportSuppFloatGetMID = env->GetMethodID(jImPlatformFuncViewportSuppFloat, "get", "(Limgui/lordbanana/ImGuiViewport;)F");

        jclass jImGuiFileDialogPaneFun = env->FindClass("imgui/lordbanana/extension/imguifiledialog/callback/ImGuiFileDialogPaneFun");
