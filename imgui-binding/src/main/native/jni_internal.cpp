...
namespace Jni
{
    void InitInternal(JNIEnv* env) {
        jclass jImRectClass = env->FindClass("imgui/lordbanana/internal/ImRect");
        imRectMin = env->GetFieldID(jImRectClass, "min", "Limgui/lordbanana/ImVec2;");
        imRectMax = env->GetFieldID(jImRectClass, "max", "Limgui/lordbanana/ImVec2;");
    }
