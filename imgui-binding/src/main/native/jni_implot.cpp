...
static void initialize(JNIEnv* env) {
    ...
    jclass jImPlotPointClass = env->FindClass("imgui/lordbanana/extension/implot/ImPlotPoint");
    imPlotPointXID = env->GetFieldID(jImPlotPointClass, "x", "D");
    imPlotPointYID = env->GetFieldID(jImPlotPointClass, "y", "D");

    jclass jImPlotRangeClass = env->FindClass("imgui/lordbanana/extension/implot/ImPlotRange");
    imPlotRangeMinID = env->GetFieldID(jImPlotRangeClass, "min", "D");
    imPlotRangeMaxID = env->GetFieldID(jImPlotRangeClass, "max", "D");

    jclass jImPlotRectClass = env->FindClass("imgui/lordbanana/extension/implot/ImPlotRect");
    imPlotRectX = env->GetFieldID(jImPlotRectClass, "x", "Limgui/lordbanana/extension/implot/ImPlotRange;");
    imPlotRectY = env->GetFieldID(jImPlotRectClass, "y", "Limgui/lordbanana/extension/implot/ImPlotRange;");
