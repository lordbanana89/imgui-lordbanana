...
public final class ImString implements Cloneable, Comparable<ImString> {
    ...
    public static final class InputData {
        ...
        /**
         * If not empty, then other chars which are different from provided will be filtered during the {@link imgui.lordbanana.ImGui#inputText}
         * and {@link imgui.lordbanana.ImGui#inputTextMultiline} methods.
         */
        public String allowedChars = "";

        /**
         * If true, then string will be resized during the {@link imgui.lordbanana.ImGui#inputText} and {@link imgui.lordbanana.ImGui#inputTextMultiline} methods.
         * Alternatively you can provide {@link imgui.lordbanana.flag.ImGuiInputTextFlags#CallbackResize} flag to the input text widgets to enable string resizing.
